...
class Car:
    ...
    def drive(self):
        ...
        a_predicted_clf = clf_control(self.v)
        throttle = a_predicted_clf#rand.uniform(0.1, 1)
...
def animate_bicycle(throttle,steering):
    ...
    road = plt.Rectangle((-32, 0), 50,50, color='gray', fill=False, linewidth=40)
